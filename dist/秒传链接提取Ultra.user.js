...
var findAndReplaceDOMText = __webpack_require__(486);
            ...
            return __generator(this, function (_a) {
                ...
                preConfirm = function () {
                    ...
                    if (!globalConfig.bdstoken) {
                        sweetalert2_all_default().showValidationMessage("<p>\u8BF7\u5148\u767B\u5F55 <a href=\"https://pan.baidu.com/\" ".concat(linkStyle, ">\u767E\u5EA6\u7F51\u76D8</a></p>, \u518D\u5237\u65B0\u6B64\u9875\u9762"));
                        return false;
                    }
                };
                willOpen = function () {
...
function ATAGListener(ele) {
    var bdlinkList = [ele.target.innerText];
    jquery_default()(ele.target)
        .siblings("a.mzf_bdlink")
        .each(function () {
        bdlinkList.push(jquery_default()(this).text());
    });
...
function addBdlinkWrap() {
    findAndReplaceDOMText_default()(document.body, {
        ...
        filterElements: function (ele) {
            var _a;
            return !(((_a = ele.classList) === null || _a === void 0 ? void 0 : _a.length) && ele.classList[0] === "mzf_bdlink");
        },
